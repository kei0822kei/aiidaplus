...
from aiida.orm import (load_node, Bool, Code, Dict, Float,
                       Group, Int, Str)
from aiidaplus.utils import get_elements_from_aiidastructure
...
def main(computer,
    ...
    builder.code = Code.get_from_string(
            '{}@{}'.format('vasp544mpi', computer))
    options = job_node.inputs.options.get_dict()
    ...
    if process_name == 'RelaxWorkChain':
        ...
        relax_conf['convergence_max_iterations'] = 20
